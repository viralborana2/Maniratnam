      ...
      <div className="container">
        ...
        <div className="row py-5 g-4">
          ...
          <div className="col-4 col-md-4">
            ...
            <ul className="footer-links">
              <li><a href="#projects">Maniratnam Serene (Heramba CHSL)</a></li>
          ...
          <div className="col-4 col-md-4">
            ...
            <div className="social-icons mt-4">
              <a 
                href="https://www.instagram.com/maniratnam_developers?igsh=MWI2bGZ0b29mMjY2aA%3D%3D" 
                target="_blank" 
              ...
              <a href="mailto:maniratnamgroup@gmail.com">
        ...
        <div className="footer-bottom text-center py-4">
          <p className="mb-0">2026 © Maniratnam Infinity Developers LPP</p>
        </div>
      </div>
